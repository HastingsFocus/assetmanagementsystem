  ...
  try {
    ...
    await Notification.insertMany(
      storesUsers.map((user) => ({
        ...
        message: `Requisition ${requisition.requisitionId} is funded.`,
      ...
      try {
        await sendEmail({
          ...
          html: `
            ...
            <p>Requisition <b>${requisition.requisitionId}</b> is funded.</p>
          `
        });
      } catch (e) {
        console.log("Store email failed:", e.message);
      }
    }
    ...
    if (hodUser) {
      try {
        ...
        console.log("HOD email failed:", e.message);
      }
    }
